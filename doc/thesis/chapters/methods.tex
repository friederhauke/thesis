...
\begin{figure}[H]
	\centering
 	 \includegraphics[scale=1]{graphics/SOA_architektur.jpg} 
...
Werden räumliche (oder geographische) Daten über das Internet zur Verfügung gestellt, ist das aus Sicht von \citep{aalders_spatial_2001} bereits eine Geodateninfrastruktur. Der Unterschied zu einer standardisierten Geodateninfrastruktur liegt darin, dass diese Daten meist nicht ohne großen Zusatzaufwand in bestehende Systeme eingebunden, und mit den Daten anderer Anbieter verschnitten werden können. Durch das Kombinieren verschiedener räumlicher Datensätze entsteht ein erheblicher Mehrwert, aus diesem Grund entwickelte das \gls{OGC} verschiedene Standards zur Visualisierung von räumlichen Daten wie zum Beispiel der \newacronym{WMS}{WMS}{Web Map Service} und zum Verwalten von räumlichen Daten wie der \newacronym{WCS}{WCS}{Web Catalogue Service}.
